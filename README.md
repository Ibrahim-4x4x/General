...
<body>
    ...
    <div class="info-section">
        <div><strong>Name:</strong> <input type="text" id="student-name" name="student-name" placeholder="Type name here..." style="border: none; border-bottom: 1px solid #000; outline: none; width: 250px; font-family: inherit;"> </div>
